...
describe("Deve retornar todos os testes do games service ", () => {
    const objeto = {
        "avaliacao": "4.90", "capa_imagem": "https://example.com/shawshank_redemption.jpg", "classificacao_etaria": 14, "data_lancamento": "1994-09-23", "descricao": "Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.", "desenvolvedor": "Frank Darabont", "editora": "Columbia Pictures", "genero": "Drama", "id": "b0ec66f0-18a3-476a-9a18-4e3292cc9935", "modos_jogo": ["Single-player", "Multiplayer"], "nome": "The Shawshank Redemption", "plataforma": ["Hulu", "HBO Max"], "price": "9.99", "requerimento_sistema": { "minimum": "Resilient spirit", "recommended": "Heartfelt emotions" }
    }
    const objetos = [
        {
    ...
    it("Deve retornar um game", async () => {
        ...
        expect(response).toEqual(objeto)
    })
})